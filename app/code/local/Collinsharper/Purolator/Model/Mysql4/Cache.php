...
/**
 * Collinsharper_Purolator_Model_Mysql4_Cache
 *
 * @category Shipping
 * @package  Collinsharper.Purolator
 * @author   Collins Harper  <ch@collinsharper.com>
 ...
 * @link     http://collinsharper.com
 */
class Collinsharper_Purolator_Model_Mysql4_Cache extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    {
        $this->_init('purolatormodule/cache', 'id');
    }
